    ...
    <div class="container">
        ...
        <div class="places-workspace work" id="id3">
            <div class="btn-tag" id="plc-op">
                <button type="button" id="v3" onclick="showDetails(document.getElementById(this.id))">view place details</button>
        ...
        <div class="hotels-workspace work" id="id4">
            <div class="btn-tag" id="htl-op">
                <button type="button" id="v4" onclick="showDetails(document.getElementById(this.id))">view hotel details</button>
